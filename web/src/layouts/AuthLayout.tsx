...
export function AuthLayout() {
  return (
    <main className="min-h-screen bg-cream px-5 py-6 sm:px-8 lg:px-12">
      <div className="mx-auto flex max-w-7xl items-center justify-between">
        <Logo />
        <span className="hidden text-sm font-medium text-ink/45 sm:block">
      ...
      <div className="mx-auto grid min-h-[calc(100vh-6rem)] max-w-7xl items-center gap-12 py-10 lg:grid-cols-[1.05fr_0.95fr] lg:py-16">
        <section className="hidden lg:block">
          ...
          <p className="mt-7 max-w-md text-lg leading-8 text-ink/55">
            A calmer home for your plans, people, and everyday momentum.
          </p>
